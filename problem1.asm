...
0000000000401000 <_init>:
  ...
  401008: 48 8b 05 d1 2f 00 00         	movq	0x2fd1(%rip), %rax      # 0x403fe0 <strcpy@GLIBC_2.2.5+0x403fe0>
...
0000000000401130 <_start>:
  ...
  401148: 48 c7 c7 58 12 40 00         	movq	$0x401258, %rdi         # imm = 0x401258
  40114f: ff 15 83 2e 00 00            	callq	*0x2e83(%rip)           # 0x403fd8 <strcpy@GLIBC_2.2.5+0x403fd8>
  401155: f4                           	hlt
...
0000000000401216 <func1>:
  ...
  40121e: bf 04 20 40 00               	movl	$0x402004, %edi         # imm = 0x402004
  401223: e8 98 fe ff ff               	callq	0x4010c0 <.plt.sec+0x10>
  401228: bf 00 00 00 00               	movl	$0x0, %edi
  40122d: e8 ee fe ff ff               	callq	0x401120 <.plt.sec+0x70>

0000000000401232 <func>:
  401232: f3 0f 1e fa                  	endbr64
  401236: 55                           	pushq	%rbp
  401237: 48 89 e5                     	movq	%rsp, %rbp
  40123a: 48 83 ec 20                  	subq	$0x20, %rsp
  40123e: 48 89 7d e8                  	movq	%rdi, -0x18(%rbp)
  401242: 48 8b 55 e8                  	movq	-0x18(%rbp), %rdx
  401246: 48 8d 45 f8                  	leaq	-0x8(%rbp), %rax
  40124a: 48 89 d6                     	movq	%rdx, %rsi
  40124d: 48 89 c7                     	movq	%rax, %rdi
  401250: e8 5b fe ff ff               	callq	0x4010b0 <.plt.sec>
  401255: 90                           	nop
  401256: c9                           	leave
  401257: c3                           	retq
...
0000000000401258 <main>:
  ...
  40125c: 55                           	pushq	%rbp
  40125d: 48 89 e5                     	movq	%rsp, %rbp
  401260: 48 81 ec 20 01 00 00         	subq	$0x120, %rsp            # imm = 0x120
  401267: 89 bd ec fe ff ff            	movl	%edi, -0x114(%rbp)
  40126d: 48 89 b5 e0 fe ff ff         	movq	%rsi, -0x120(%rbp)
  401274: bf 14 20 40 00               	movl	$0x402014, %edi         # imm = 0x402014
  401279: e8 42 fe ff ff               	callq	0x4010c0 <.plt.sec+0x10>
  40127e: 83 bd ec fe ff ff 02         	cmpl	$0x2, -0x114(%rbp)
  401285: 74 2d                        	je	0x4012b4 <main+0x5c>
  401287: 48 8b 85 e0 fe ff ff         	movq	-0x120(%rbp), %rax
  40128e: 48 8b 10                     	movq	(%rax), %rdx
  401291: 48 8b 05 c8 2d 00 00         	movq	0x2dc8(%rip), %rax      # 0x404060 <stderr@GLIBC_2.2.5>
  401298: be 25 20 40 00               	movl	$0x402025, %esi         # imm = 0x402025
  40129d: 48 89 c7                     	movq	%rax, %rdi
  4012a0: b8 00 00 00 00               	movl	$0x0, %eax
  4012a5: e8 46 fe ff ff               	callq	0x4010f0 <.plt.sec+0x40>
  4012aa: b8 01 00 00 00               	movl	$0x1, %eax
  4012af: e9 bd 00 00 00               	jmp	0x401371 <main+0x119>
  4012b4: 48 8b 85 e0 fe ff ff         	movq	-0x120(%rbp), %rax
  4012bb: 48 83 c0 08                  	addq	$0x8, %rax
  4012bf: 48 8b 00                     	movq	(%rax), %rax
  4012c2: be 37 20 40 00               	movl	$0x402037, %esi         # imm = 0x402037
  4012c7: 48 89 c7                     	movq	%rax, %rdi
  4012ca: e8 31 fe ff ff               	callq	0x401100 <.plt.sec+0x50>
  4012cf: 48 89 45 f8                  	movq	%rax, -0x8(%rbp)
  4012d3: 48 83 7d f8 00               	cmpq	$0x0, -0x8(%rbp)
  4012d8: 75 14                        	jne	0x4012ee <main+0x96>
  4012da: bf 39 20 40 00               	movl	$0x402039, %edi         # imm = 0x402039
  4012df: e8 2c fe ff ff               	callq	0x401110 <.plt.sec+0x60>
  4012e4: b8 01 00 00 00               	movl	$0x1, %eax
  4012e9: e9 83 00 00 00               	jmp	0x401371 <main+0x119>
  4012ee: 48 8b 55 f8                  	movq	-0x8(%rbp), %rdx
  4012f2: 48 8d 85 f0 fe ff ff         	leaq	-0x110(%rbp), %rax
  4012f9: 48 89 d1                     	movq	%rdx, %rcx
  4012fc: ba 00 01 00 00               	movl	$0x100, %edx            # imm = 0x100
  401301: be 01 00 00 00               	movl	$0x1, %esi
  401306: 48 89 c7                     	movq	%rax, %rdi
  401309: e8 c2 fd ff ff               	callq	0x4010d0 <.plt.sec+0x20>
  40130e: 48 89 45 f0                  	movq	%rax, -0x10(%rbp)
  401312: 48 83 7d f0 00               	cmpq	$0x0, -0x10(%rbp)
  401317: 75 1d                        	jne	0x401336 <main+0xde>
  401319: bf 3f 20 40 00               	movl	$0x40203f, %edi         # imm = 0x40203F
  40131e: e8 ed fd ff ff               	callq	0x401110 <.plt.sec+0x60>
  401323: 48 8b 45 f8                  	movq	-0x8(%rbp), %rax
  401327: 48 89 c7                     	movq	%rax, %rdi
  40132a: e8 b1 fd ff ff               	callq	0x4010e0 <.plt.sec+0x30>
  40132f: b8 01 00 00 00               	movl	$0x1, %eax
  401334: eb 3b                        	jmp	0x401371 <main+0x119>
  401336: 48 8d 95 f0 fe ff ff         	leaq	-0x110(%rbp), %rdx
  40133d: 48 8b 45 f0                  	movq	-0x10(%rbp), %rax
  401341: 48 01 d0                     	addq	%rdx, %rax
  401344: c6 00 00                     	movb	$0x0, (%rax)
  401347: 48 8b 45 f8                  	movq	-0x8(%rbp), %rax
  40134b: 48 89 c7                     	movq	%rax, %rdi
  40134e: e8 8d fd ff ff               	callq	0x4010e0 <.plt.sec+0x30>
  401353: 48 8d 85 f0 fe ff ff         	leaq	-0x110(%rbp), %rax
  40135a: 48 89 c7                     	movq	%rax, %rdi
  40135d: e8 d0 fe ff ff               	callq	0x401232 <func>
  401362: bf 45 20 40 00               	movl	$0x402045, %edi         # imm = 0x402045
  401367: e8 54 fd ff ff               	callq	0x4010c0 <.plt.sec+0x10>
  40136c: b8 00 00 00 00               	movl	$0x0, %eax
  401371: c9                           	leave
  401372: c3                           	retq
...
0000000000401374 <_fini>:
  ...
  401378: 48 83 ec 08                  	subq	$0x8, %rsp
  40137c: 48 83 c4 08                  	addq	$0x8, %rsp
  401380: c3                           	retq
